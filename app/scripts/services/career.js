...
/**
 * @ngdoc service
 * @name tagbgroupApp.career
 * @description
 * # career
 * Factory in the tagbgroupApp.
 */
angular.module('tagbgroupApp')
  .factory('career', function () {
    var employmentGuideline = {
    ...
    return {
      getEmploymentGuideline: function () {
        return employmentGuideline;
      },
      getEmploymentStatement: function() {
        return employmentStatement;
      }
    };
  });
